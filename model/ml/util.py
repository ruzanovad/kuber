...
def get_class_of_sample(input, device=DEVICE, weights="fine_tuned_resnet50.pth", label_encoder="label_encoder.pkl"):
    ...
    resnet.load_state_dict(torch.load(weights, map_location=device, weights_only=True))
